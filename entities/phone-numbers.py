...
random_mobile_numbers = [{"phone": generate_mobile_number()} for _ in range(NUMBER_OF_ENTITIES)]

# Save the list to a JSON file
with open('phone_numbers.json', 'w') as file:
    json.dump(random_mobile_numbers, file, indent=4)

print(f"{NUMBER_OF_ENTITIES} random mobile numbers saved to 'phone_numbers.json'")
