...
def generate_random_strings(count):
    ...
    for _ in range(count):
        ...
        middle_part = str(random.randint(3000, 9999))
        last_part = random.choice(string.ascii_uppercase)
        random_string = first_part + middle_part + last_part
        data = {"pan_num" : random_string}
...
if __name__ == "__main__":
    ...
    save_to_json(random_strings, "pan_card.json")

    print(f"{NUMBER_OF_ENTITIES} random strings have been generated and saved to 'pan_card.json'.")
